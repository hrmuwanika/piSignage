# Release Notes for piSignage Original Player (3.x.x and earlier)

This document covers the original (legacy) player line — versions 3.x.x and earlier. Some entries are joint **Server + Player** releases; the player notes are kept here intact, while server-only releases of the same era live in [RELEASE NOTES - Server.md](<RELEASE NOTES - Server.md>).

For the rewritten Player2 line (4.x.x and 5.x.x), see [RELEASE NOTES - Player 5.x.x.md](<RELEASE NOTES - Player 5.x.x.md>).
